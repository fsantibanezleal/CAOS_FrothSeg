...
watershed, H-minima watershed, SLIC, and lamella-valley watershed. They run on a
selected sample or upload and produce an instance map and BSD immediately.

These are semantic twins of the authoritative Python implementations. Exact
numeric equality is not promised because numerical libraries differ. Release
comparisons use offline Python evidence only.
