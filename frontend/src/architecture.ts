  ...
  tabs: [
    {
      ...
      body_en:
        ...
        'froth state, entirely in the browser. It takes a frame (a real froth photo, or a synthetic ' +
        'sample) and returns the per-bubble instance masks, the size distribution (D10/D50/D90, the Sauter mean ' +
        'd32) and a froth-state read-out.\n\n' +
        'It is a real workbench, not a demo. The segmenter genuinely runs on the provided frame; nothing on the ' +
    ...
    },
    {
      ...
      body_es:
        ...
        'instancias limpio.\n\n' +
        'Un piso clásico (watershed controlado por marcadores + SLIC, scikit-image) se ejecuta en paralelo como la ' +
    ...
    },
    {
      ...
      body_en:
        ...
        'model is fetched once from the Hugging Face hub and cached; inference runs client-side on the frame. The ' +
