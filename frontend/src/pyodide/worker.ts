// LIVE lane (optional, Pyodide): load the inlined fslab sources (public/pyodide/sources.json) and call
// fslab.live.run_trace_json for a bring-your-own-params interaction in the browser. This is a STUB — a real
