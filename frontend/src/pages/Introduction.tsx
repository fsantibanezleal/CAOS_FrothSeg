    ...
    <div className="page-body prose">
      ...
      <section>
        ...
        {/* Sources for the transfer figures above, all in this repository:
            ...
            classical mean delta +0.070 over 7 methods, in-repo trained mean delta -0.243 over 6) and
