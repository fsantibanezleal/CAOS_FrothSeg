...
function Overview({ es, benchmark }: BenchmarkProps) {
  ...
  return (
    <div className="fs-benchmark-chapter">
      ...
      <Equation tex={String.raw`\mathrm{AP}=\frac{1}{10}\sum_{\tau=0.50}^{0.95}\mathrm{AP}_{\tau}`} caption={es ? 'AP(t) = TP / (TP + FP + FN), promediado en diez umbrales IoU. Es la definición de Cellpose y StarDist, no el AP de COCO.' : 'AP(t) = TP / (TP + FP + FN), averaged over ten IoU thresholds. This is the Cellpose and StarDist definition, not COCO AP.'} />
