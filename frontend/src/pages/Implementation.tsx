    ...
    <div className="prose">
      ...
      <Callout variant="honest" title={es ? 'Paridad es acuerdo, no calidad' : 'Parity is agreement, not quality'}>
        {es
          ...
          : 'The three accepted twins are part of the classical floor and sit below the comparison bar: their mean untouched-test AP values are 0.065, 0.220, and 0.198. Their agreement with the offline version means the browser does not lie about what it runs, not that they are good. The live lane is exploratory by design and the measured leader is not in the browser; an installed dependency does not prove an implementation either, because the registry demands a checkpoint or configuration, inference, held-out evaluation, artifacts, and documentation.'}
        {/* C1 0.0652, C3 0.2196, C4 0.1977 test mean_ap: data/derived/method-benchmark.json. C3 moved with the
    ...
    <div className="prose">
      ...
      <Callout variant="honest" title={es ? 'El inventario está incompleto, y lo dice' : 'The inventory is incomplete, and says so'}>
        ...
        {/* complete false and the single blocking error: data/derived/release-report.json.
            ...
            a delta of -0.0173; C3 goes from 0.21957813 to 0.12782813, a delta of -0.0917, which appeared
            when the C3 flooding surface was adopted (verification/phase1-adoption.json); the other five
            classical rows are positive and the +0.070 tier mean is exact over all seven. The earlier
